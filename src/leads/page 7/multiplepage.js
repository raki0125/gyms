...
export const allGyms = [
  { id: 1, name: 'Fitness Honor', brandName: 'FITNESS HONOR' },
  { id: 2, name: 'Fitness 1plus', brandName: 'FITNESS 1PLUS' },
  { id: 3, name: 'Power Fitness', brandName: 'POWER FITNESS' },
  { id: 4, name: 'Star Gold Fitness', brandName: 'STAR GOLD FITNESS' },
  { id: 5, name: 'VS Fitness Club', brandName: 'VS FITNESS CLUB' },
  { id: 6, name: 'Fitness World Gym', brandName: 'FITNESS WORLD GYM' },
  { id: 7, name: 'Core Fit Gym', brandName: 'CORE FIT GYM' },
  { id: 8, name: 'Star Fitness', brandName: 'STAR FITNESS' },
  { id: 9, name: 'Arjun Muscle World', brandName: 'ARJUN MUSCLE WORLD' },
  { id: 10, name: 'RK Fitness World', brandName: 'RK FITNESS WORLD' },
  { id: 11, name: 'Fitness Gym King', brandName: 'FITNESS GYM KING' },
  { id: 12, name: 'Hammer Fitness', brandName: 'HAMMER FITNESS' },
  { id: 13, name: 'Xtreme Fitness Studio', brandName: 'XTREME FITNESS STUDIO' },
  { id: 14, name: 'Universal Gym', brandName: 'UNIVERSAL GYM' },
  { id: 15, name: 'KM3 Platinum Fitness', brandName: 'KM3 PLATINUM FITNESS' },
  { id: 16, name: 'New Fitness Station', brandName: 'NEW FITNESS STATION' },
  { id: 17, name: 'Dream Fitness', brandName: 'DREAM FITNESS' }
];

export function renderMPage(container, subpage = 1) {
  const currentSubpage = Number(subpage) || 1;
  const gym = allGyms.find(g => g.id === currentSubpage) || allGyms[0];
  ...
  container.innerHTML = `
    <div class="p1">
      ...
      <!-- STICKY NAVBAR -->
      <nav class="p1-nav">
        <div class="p1-logo">${gym.brandName}</div>
      ...
      <section id="p1-hero" class="p1-hero">
        ...
        <div class="p1-hero-text">
          ...
          <p class="p1-subtext">
            Transform your physique with ${gym.name}'s most advanced gym coaching system. 
        ...
        <div class="p1-hero-img-wrap">
          <img src="${heroImg}" alt="${gym.name} Athlete" class="p1-hero-img" />
      ...
      <section id="p1-about" class="p1-section">
        <div class="p1-section-header">
          <div class="p1-section-tag">THE ${gym.brandName} SYSTEM</div>
          <h2 class="p1-section-title">Built for Peak Athletic Performance</h2>
          <p class="p1-section-sub">${gym.name}'s advanced gym coaching methodology — combining heavy compound movements, precision nutrition, and daily accountability coaching.</p>
        </div>
        <div class="p1-grid-3">
          <div class="p1-card">
      ...
      <section id="p1-membership" class="p1-section">
        <div class="p1-section-header">
          ...
          <p class="p1-section-sub">Flexible monthly memberships at ${gym.name} with full access to gym floor, coaches, and app tracking.</p>
        </div>
        <div class="p1-grid-3">
          <!-- STARTER PLAN -->
          <div class="p7-price-card-flip-wrap reveal">
            <div class="p7-price-card-inner">
              ...
              <div class="p7-price-card-back">
                ...
                <form class="p7-join-form" onsubmit="event.preventDefault(); alert('Thank you! Your request for ${gym.name} Starter plan has been received.');">
          ...
          <div class="p7-price-card-flip-wrap featured reveal">
            <div class="p7-price-card-inner">
              ...
              <div class="p7-price-card-back featured">
                ...
                <form class="p7-join-form" onsubmit="event.preventDefault(); alert('Thank you! Your request for ${gym.name} Pro plan has been received.');">
                  <div class="p7-form-group"><input type="text" class="p7-form-input" placeholder="Full Name" required /></div>
                  <div class="p7-form-group"><input type="tel" class="p7-form-input" placeholder="Phone Number" required /></div>
                  <div class="p7-form-group"><input type="email" class="p7-form-input" placeholder="Email Address" required /></div>
                  <button type="submit" class="p7-form-submit-btn">Submit Request</button>
          ...
          <div class="p7-price-card-flip-wrap reveal">
            <div class="p7-price-card-inner">
              ...
              <div class="p7-price-card-back">
                ...
                <form class="p7-join-form" onsubmit="event.preventDefault(); alert('Thank you! Your request for ${gym.name} VIP plan has been received.');">
                  <div class="p7-form-group"><input type="text" class="p7-form-input" placeholder="Full Name" required /></div>
                  <div class="p7-form-group"><input type="tel" class="p7-form-input" placeholder="Phone Number" required /></div>
                  <div class="p7-form-group"><input type="email" class="p7-form-input" placeholder="Email Address" required /></div>
                  <button type="submit" class="p7-form-submit-btn">Submit Request</button>
      ...
      <footer id="p1-contact" class="p1-footer">
        <div class="p1-footer-top">
          <div>
            <div class="p1-footer-brand-name">${gym.brandName}</div>
        ...
        <div class="p1-footer-bottom">&copy; 2026 ${gym.name}. All rights reserved.</div>
      </footer>
...
export function renderPage7(container, navigateTo) {
  renderMPage(container, 1);
}
