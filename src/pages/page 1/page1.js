...
export function renderPage1(container) {
  container.innerHTML = `
    <div class="p1">
      ...
      <!-- STICKY NAVBAR -->
      <nav class="p1-nav">
        <div class="p1-logo">NEXIUM FITNESS</div>
      ...
      <section id="p1-hero" class="p1-hero">
        ...
        <div class="p1-hero-img-wrap">
          <img src="${heroImg}" alt="Nexium Gym Athlete" class="p1-hero-img" />
          <div class="p1-img-badge">
            <div>
              <div class="p1-badge-num">50K+</div>
              <div class="p1-badge-txt">Athletes Trained</div>
            </div>
            <div style="width:1px;background:rgba(255,255,255,0.1);height:36px;"></div>
            <div>
      ...
      <section id="p1-about" class="p1-section">
        <div class="p1-section-header">
          <div class="p1-section-tag">THE NEXIUM SYSTEM</div>
      ...
      <section id="p1-membership" class="p1-section">
        ...
        <div class="p1-grid-3">
          <div class="p1-card">
            ...
            <div class="p1-card-title">Basic Gym Access</div>
            <div class="p1-card-desc">Unlimited gym floor access, free weights, cardio zone and locker rooms.</div>
            <div class="p1-price">₹1,499<sub>/mo</sub></div>
            <button class="p1-buy-btn">Join Basic</button>
          </div>
          <div class="p1-card featured">
            <div class="p1-card-badge">Most Popular</div>
            <div class="p1-card-title">Pro Fitness + Coaching</div>
            <div class="p1-card-desc">Full gym access + monthly 1-on-1 personal trainer sessions & custom meal plan.</div>
            <div class="p1-price">₹2,999<sub>/mo</sub></div>
            <button class="p1-buy-btn primary">Join Pro</button>
          </div>
          <div class="p1-card">
            <div class="p1-card-badge">VIP Elite</div>
            <div class="p1-card-title">Elite Personal Training</div>
            <div class="p1-card-desc">Dedicated coach 3x weekly, cryotherapy recovery, and custom supplementation plan.</div>
            <div class="p1-price">₹5,999<sub>/mo</sub></div>
            <button class="p1-buy-btn">Join VIP</button>
          </div>
        </div>
      </section>
      ...
      <section id="p1-results" class="p1-section">
        ...
        <div class="p1-stats">
          ...
          <div class="p1-stat">
            <div class="p1-stat-num">50,000+</div>
            <div class="p1-stat-label">Athletes Trained Across India</div>
          </div>
          <div class="p1-stat">
      ...
      <footer id="p1-contact" class="p1-footer">
        <div class="p1-footer-top">
          <div>
            <div class="p1-footer-brand-name">NEXIUM FITNESS</div>
        ...
        <div class="p1-footer-bottom">&copy; 2026 NEXIUM Fitness India. All rights reserved.</div>
      </footer>
  ...
  container.querySelectorAll('.p1-card, .p1-stat, .p1-feature-item, .p1-faq-item').forEach(el => {
...
if (!document.querySelector('#nexium-ripple-style')) {
  const s = document.createElement('style');
  s.id = 'nexium-ripple-style';
