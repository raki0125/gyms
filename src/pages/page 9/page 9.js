...
export function renderPage9(container) {
  container.innerHTML = `
    <div class="p1">
      ...
      <div class="p1-ticker">
        <div class="p1-ticker-inner">
          ...
          <span>Sport Life Fitness Club</span>
      ...
      <section id="p1-hero" class="p1-hero">
        ...
        <div class="p1-hero-img-wrap">
          <img src="${heroImg}" alt="Sport Life Fitness Club Athlete" class="p1-hero-img" />
      ...
      <section id="p1-about" class="p1-section">
        <div class="p1-section-header">
          <div class="p1-section-tag">THE SPORT LIFE FITNESS CLUB SYSTEM</div>
      ...
      <footer id="p1-contact" class="p1-footer">
        ...
        <div class="p1-footer-bottom">&copy; 2026 Sport Life Fitness Club India. All rights reserved.</div>
      </footer>
...
if (!document.querySelector('#sport-life-ripple-style')) {
  const s = document.createElement('style');
  s.id = 'sport-life-ripple-style';
