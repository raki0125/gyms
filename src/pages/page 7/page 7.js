...
export function renderPage7(container) {
  container.innerHTML = `
    <div class="p1">
      ...
      <!-- STICKY NAVBAR -->
      <nav class="p1-nav">
        <div class="p1-logo">FITNESS HONOR</div>
      ...
      <section id="p1-hero" class="p1-hero">
        ...
        <div class="p1-hero-img-wrap">
          <img src="${heroImg}" alt="Fitness Honor Gym Athlete" class="p1-hero-img" />
      ...
      <section id="p1-about" class="p1-section">
        <div class="p1-section-header">
          <div class="p1-section-tag">THE FITNESS HONOR SYSTEM</div>
      ...
      <footer id="p1-contact" class="p1-footer">
        <div class="p1-footer-top">
          <div>
            <div class="p1-footer-brand-name">FITNESS HONOR</div>
        ...
        <div class="p1-footer-bottom">&copy; 2026 Fitness Honor India. All rights reserved.</div>
      </footer>
...
if (!document.querySelector('#fitness-honor-ripple-style')) {
  const s = document.createElement('style');
  s.id = 'fitness-honor-ripple-style';
